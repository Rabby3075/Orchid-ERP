            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8 mx-auto">
                        ...
                        <div class="card">
                            <div class="card-header">Update Email Template </div>
                            <div class="card-body">

                                <form action="/update-email-template/{{$temp->id}}" method="POST">
                                    @csrf
                                        ...
                                        <div class="col-md-8 input-group">
                                            ...
                                            <select id="state" class="form-control select2 bg-white" name="groupId"  >
                                                ...
                                                @foreach($user as $select)
                                                    <option @if ($select->id === $temp->groupId) selected @endif value="{{$select->id}}">{{$select->groupName}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" name="subject" value="{{$temp->subject}}" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label">Message</label>
                                        <div class="col-md-8">
                                            <textarea  class="form-control" name="body">{{$temp->body}}</textarea>
                                        </div>
                                    </div>
