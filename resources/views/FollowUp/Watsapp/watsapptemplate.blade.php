        ...
        <div class="row">
            <div class="col-lg-12 bg-white mx-auto mt-5">
                ...
                <div class="card bg-white">
                    <h4 class="card-header">All Watsapp Templates</h4>

                    <div class="card-body bg-white">
                        <div class="bg-white">
                            <form action="/watsapp-template-search" method="GET">
                                <div class="form-group row">
                                    <label class="col-md-6">
                                        <input type="text" class="form-control bg-white" name="query" value="Search"/>
                                    </label>
                                    <div class="col-md-6 ml-0">
                                        <span class="float-right col-md-6"><a href="/watsapp-template-form" class="btn btn-success float-right">+Add</a></span>
                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                @foreach ($templates as $template)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/edit-watsapp-template/{{$template->id}}" class="btn btn-success btn-sm" style="margin-right: 3px;" title="Update">
                                            ...
                                            <br> <br>
                                            <a href="/send-message-form/{{$template->id}}" class="btn btn-primary btn-sm" title="Update">
                                                Send Message
                                            </a>
...
{{--            Toast.fire({--}}
{{--                icon: 'success',--}}
{{--                title: 'Watsapp Sent Successfully'--}}
{{--            })--}}
{{--        }--}}
{{--        function wise_words()--}}
{{--        {--}}
...
{{--            Toast.fire({--}}
{{--                icon: 'success',--}}
{{--                title: 'Watsapp Template Deleted Successfully'--}}
{{--            })--}}
{{--        }--}}
{{--        function update()--}}
{{--        {--}}
...
{{--            Toast.fire({--}}
{{--                icon: 'success',--}}
{{--                title: 'Watsapp Template Updated Successfully'--}}
{{--            })--}}
{{--        }--}}
{{--    </script>--}}
