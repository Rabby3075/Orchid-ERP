                    ...
                    <div class="col-md-12 mx-auto">
                        <div class="card">
                            <div class="card-header">
                                <span>Update Stock Transfer</span>
                            </div>
                            <div class="card-body">
                                <form action="{{route('stockTransferUpdate')}}" class="form-group" method="POST" enctype="multipart/form-data">
                                    @csrf
                                            ...
                                            <div class="input-group search_select_box">
                                                <select class="form-control" name="from" id="from"data-live-search="true">
                                                    ...
                                                    @foreach($branches as $branch)
                                                        <option @if($branch->id === $From->id) selected @endif value="{{$branch->id}}">{{$branch->branchName}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group search_select_box">
                                                <select class="form-control" name="to" id="to"data-live-search="true">
                                                    <option value="">Select a branch</option>
                                                    @foreach($branches as $branch)
                                                        <option @if($branch->id === $To->id) selected @endif value="{{$branch->id}}">{{$branch->branchName}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" type="number" name="transferQuantity" id="transferQuantity" value={{$stock->TransferQuantity}} onkeyup="AmountCalculation(this.value)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" type="number" name="shippingCharge" id="shippingCharge" value={{$stock->ShippingCharge}}>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="note">Note</label>
                                            <textarea class="form-control" type="note" name="note" id="note">{{$stock->note}}</textarea>
                                        </div>
                                    </div>
