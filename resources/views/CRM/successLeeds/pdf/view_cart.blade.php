...
{{--        </div>--}}
        ...
        <table >
            ...
            <tr>
                <th></th>
                <th colspan="5" class="table-text">Total Amount</th>

                <td colspan="2" class="table-text">{{$quotes->totalAmount}}</td>
            </tr>
            <tr>
                <th></th>
                <th colspan="5" class="table-text">Vat</th>

                <td colspan="2" class=" table-text">{{$quotes->totalVat}}</td>
            </tr>
            <tr>
                <th></th>
                <th colspan="5" class="table-text">Discount</th>

                <td colspan="2" class="table-text">{{$quotes->discount}}</td>
            </tr>
            <tr>
                <th></th>
                <th colspan="5" class="table-text">Grand Total amount</th>

                <td colspan="2" class="th1 table-text">{{$quotes->grandTotal}}</td>
            </tr>
            </tbody>
        </table>
        <div class="bottom">
            <div class="new2">
                ...
                ?>
            <p style="font-weight: 900;font-size: 15px" class="page-break"><b>In word: {{ucwords(trans($f->format($quotes->grandTotal)))}} Taka Only</b></p>
            <div class="bottomCenter">
                <b style="font-weight: 900;font-size: 19px;margin-bottom: 0px;">Terms and conditions for payment schedule:</b>
