                ...
                <div class="row">
                    <div class="col-md-8 mx-auto">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('addAccountGroupPost')}}" method="POST">
                                    @csrf
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control" name="accType">
                                                ...
                                                @foreach ($accountTypes as $type)
                                                    <option value="{{$type->id}}">{{$type->AccountType}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control" type="text" name="group" id="group" placeholder="Please write an account group under an Account Type">
                                        </div>
                                    </div>
