        ...
        <div class="row">
            <div class="col-lg-12 bg-white mx-auto mt-5">
                ...
                <div class="card bg-white">
                    <h4 class="card-header">Adjusting Journal List</h4>
                            ...
                            <form action="#" method="GET">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 ml-0">
                                        <span class="float-right col-md-6"><a href="{{route('addadjustingJournal')}}" class="btn btn-success float-right">+Add</a></span>
                            ...
                            <table class="table table-bordered mb-0" id="myTable">
                                ...
                                @foreach ($jounrals as $jounral)
                                    <tr>
                                        ...
                                        <td>
                                            <a  class="btn btn-danger btn-sm" id="delete" title="Delete" href="javascript:void(0)" data-url="{{ route('getAdjustingJournal', $jounral->id) }}" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-danger">Adjusting Journal Delete</h5>
                </div>
                <div class="modal-body">
                    <span class="text-dark">Are you sure to delete this Adjusting Journal?</span>
                </div>
                <div class="modal-footer">
                    <form action="{{route('deleteAdjustingJournal')}}" class="form-group" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
