    ...
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-light">
            ...
            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="/Employee-Password/{{$user->id}}" class="nav-link px-0 align-middle active p-2">
        ...
        <div class="col py-3">
            <!-- Content Area -->
            <div class="card bg-white">
            <h4 class="card-header">Employee Force Change Password</h4>
                <div class="card-body bg-white">
                <form action="{{route('changePassword')}}" class="form-group" method="POST" enctype="multipart/form-data">
                <input class="form-control" type="hidden" name="id" id="id" value="{{$user->id}}">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <label for="name">Enter New Password</label>
                                        <input class="form-control" type="password" name="npass" id="npass" placeholder="Enter your new password">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="joining">Enter New Confirm Password</label>
                                        <input class="form-control" type="password" name="cpass" id="cpass" placeholder="Retype your new password">
                                    </div>
                                </div>
                                <div class="form-group row">
