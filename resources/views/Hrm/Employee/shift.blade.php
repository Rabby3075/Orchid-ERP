    ...
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-light">
            ...
            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="/Employee-shift/{{$user->id}}" class="nav-link px-0 align-middle active p-2">
        ...
        <div class="col py-3">
            <!-- Content Area -->
            <div class="card bg-white">
            <h4 class="card-header">Add New Shift</h4>
                <div class="card-body bg-white">
                <form action="{{route('shiftPost')}}" class="form-group" method="POST" enctype="multipart/form-data">
                <input class="form-control" type="hidden" name="id" id="id" value="{{$user->id}}">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        <label for="from">From Date</label>
                                        <input class="form-control" type="date" name="from" id="from" value="{{@$shift->From}}">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="to">To Date</label>
                                        <input class="form-control" type="date" name="to" id="to" value="{{@$shift->To}}">
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="submit" class="btn btn-success" value="@if(!empty($shift->EmployeeId)) Update @else Save @endif"/>
                                    </div>
                                </div>
                            </form>
                </div>
...
<!--Side Bar code-->
    ...
    <script>
        function create()
        {
            ...
            Toast.fire({
                icon: 'success',
                title: 'Shift Inserted Successfully'
            })
        }
        function wise_words()
        {
