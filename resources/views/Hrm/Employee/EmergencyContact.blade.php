    ...
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-light">
            ...
            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="/Employee-Econtact/{{$user->id}}" class="nav-link px-0 align-middle active p-2">
        ...
        <div class="col py-3">
            <!-- Content Area -->
            <div class="card bg-white">
            <h4 class="card-header" id="header">Add New Emergency Contact</h4>
                <div class="card-body bg-white">
                <form action="{{route('EcontactPost')}}" class="form-group" id="StoreInfo" method="POST" enctype="multipart/form-data">
                <input class="form-control" type="hidden" name="id" id="id" value="{{$user->id}}">
                <input class="form-control" type="hidden" name="econtactId" id="econtactId">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <label for="relation">Relation</label>
                                        <div class="input-group search_select_box">
                                        <select class="form-control" name="relation" id="relation" data-live-search="true">
                                        ...
                                        <option value="Laws">In Laws</option>
                                        </select> </div> <br>
                                        <input  type="checkbox" id="primary" name="contactType[]" value="Primary Contact">
                                        <label>Primary Contact</label> &emsp;
                                        <input  type="checkbox" id="dependent" name="contactType[]" value="Dependent">
                                        <label>Dependent</label>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="email">Email</label>
                                        <input class="form-control" type="email" name="WorkEmail" id="WorkEmail" placeholder="Work"><br>
                                        <input class="form-control" type="email" name="PersonalEmail" id="PersonalEmail" placeholder="Personal">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" type="text" name="address1" id="address1" placeholder="Address Line 1"><br>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                        <div class="col-md-8">
                                        <input class="form-control" type="tel" name="workPhone" id="workPhone" placeholder="Work Phone">
                                        </div>
                                        <div class="col-md-4">
                                        <input class="form-control" type="text" name="ext" id="ext" placeholder="Ext">
                                        </div>
                                        </div><br>
                                        <input class="form-control" type="tel" name="mobilePhone" id="mobilePhone" placeholder="Mobile Phone"><br>
                                        <input class="form-control" type="tel" name="homePhone" id="homePhone" placeholder="Home">
                                    </div>
                                    <div class="col-md-6">
                                    <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <label for="state">State</label>
                                        <input class="form-control" type="text" name="state" id="state" placeholder="State/Province">
                                    </div>
                                    <div class="col-md-4">
                                    <label for="zcode">Zip Code</label>
                                        <input class="form-control" type="text" name="zcode" id="zcode" placeholder="Zipcode">
                                    </div>
                                    </div> <br>
                                    <div class="input-group search_select_box">
            ...
            <div class="card bg-white">
            <h4 class="card-header">List All Contact</h4>
            <div class="card-body bg-white">
            <div class="table-responsive">
                            <table class="table table-bordered mb-0" id="myTable">
                                ...
                                <td>{{$econtact->Name}}</td>
                                <td>{{$econtact->Relation}}</td>
                                <td>Work Email: {{$econtact->WorkEmail}}, Personal Email: {{$econtact->PersonalEmail}}</td>
                                <td>{{$econtact->MobilePhone}}</td>
                                <td>
                                    <a href="javascript:void(0)" class="btn btn-success btn-sm me-1" title="Update" id="update" data-url="{{route('GetEmergencyContact',$econtact->id)}}">
                                    <i class="fa fa-edit"></i>
                                    </a>
                                    <a  class="btn btn-danger btn-sm" id="delete" title="Delete" href="javascript:void(0)" data-url="{{route('GetEmergencyContact',$econtact->id)}}" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-danger">Emergency Contact Delete</h5>
                </div>
                <div class="modal-body">
                        <span class="text-dark">Are you sure to delete this Emergency Contact?</span>
                </div>
                <div class="modal-footer">
                <form action="{{route('DeleteEmergencyContact')}}" class="form-group" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
    ...
    <script>
        ...
        $(document).ready(function () {
            $('body').on('click', '#update', function () {
                ...
                $('#submit').val('Update')
                $('#StoreInfo').attr('action','/Employee-Econtact-Update');
                var userURL = $(this).data('url');
                $.get(userURL, function (data) {

                    $('#econtactId').val(data.id);
                    $('#relation').val(data.Relation).change();
                    ...
                    var obj = jQuery.parseJSON(data.RelationType);
                    ...
                    if(obj.length === 2){
                        ...
                        if(obj[0] === "Primary Contact"){
                            $('#primary').prop('checked', true);
                            $('#dependent').prop('checked', false);
                        }
                        else if(obj[0] === "Dependent"){
