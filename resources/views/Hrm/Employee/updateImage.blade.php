    ...
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-light">
            ...
            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="/Employee-Image/{{$user->id}}" class="nav-link px-0 align-middle active p-2">
        ...
        <div class="col py-3">
            ...
            <h4 class="card-header">Employee Force Change Password</h4>
                <div class="card-body bg-white">
                <form action="{{route('imageUpdate')}}" class="form-group" method="POST" enctype="multipart/form-data">
                <input class="form-control" type="hidden" name="id" id="id" value="{{$user->id}}">
                                @csrf

                                    <input type="file" name="image" id="image">
                                    <img src="@if(empty($user->photo)) ../employeeImages/index.png @else ../employeeImages/{{$user->photo}} @endif" alt="" width="120" height="120">
