                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="#" method="POST">
                                @csrf
                                <input class="form-control" type="hidden" name="id" id="id" value="{{$shift->id}}">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group search_select_box">
                                            <select class="form-control" name="shiftName" id="shiftName" data-live-search="true">
                                                ...
                                                @foreach($shifts as $hrmshift)
                                                <option @if($hrmshift->id === $shiftName->id) selected @endif >{{$hrmshift->shiftName}}</option>
                                                @endforeach
                                            </select>
                                        </div>
