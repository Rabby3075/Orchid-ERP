            ...
            <div class="container">
                <div class="card">
                    <div class="card-header">
                        <span>Update Increment</span>
                    </div>
                    <div class="card-body">
                        <form action="{{route('updateIncrement')}}" method="POST">
                            @csrf
                            <input class="form-control" type="hidden" name="id" id="id" value="{{$increments->id}}" readonly>
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" type="number" name="beforeSalary" id="beforeSalary" value="{{$increments->BeforeSalary}}" readonly>
                                </div>
                                <div class="col-md-4">
                                    <label for="incrementAmount">Increment Amount</label>
                                    <input class="form-control" type="number" name="incrementAmount" id="incrementAmount" value="{{$increments->IncrementSalary}}" onkeyup="salaryCalculate()">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" type="number" name="presentSalary" id="presentSalary" value="{{$increments->NewSalary}}" readonly>
                                </div>
                                <div class="col-md-4">
                                    <label for="effectiveDate">Effective Date</label>
                                    <input class="form-control" type="date" name="effectiveDate" id="effectiveDate" value="{{$increments->EffectiveDate}}">
                                </div>
                                <div class="col-md-4">
                                    <label for="note">Note</label>
                                    <textarea class="form-control" name="note" id="note">{{$increments->Note}}</textarea>
                                </div>
                            </div>
