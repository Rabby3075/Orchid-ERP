                                    ...
                                    <div class="input-group search_select_box">
                                        <select class="form-control" name="employee" id="employee" data-live-search="true">
                                            ...
                                            @foreach ($users as $user)
                                                <option @if (!is_null($userName) && $user->id == $userName->id) selected @endif
                                            ...
                                            <div class="input-group search_select_box">
                                                <select class="form-control" name="department" id="department"
                                                    ...
                                                    @foreach ($departments as $department)
                                                        <option @if (!is_null($departmentName) && $department->id == $departmentName->id) selected @endif
                                            ...
                                            <div class="input-group search_select_box">
                                                <select class="form-control" name="location" id="location"
                                                    ...
                                                    @foreach ($branches as $branch)
                                                        <option @if (!is_null($branchName) && $branch->id == $branchName->id) selected @endif
                                                            value="{{ $branch->id }}">{{ $branch->companyName }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
