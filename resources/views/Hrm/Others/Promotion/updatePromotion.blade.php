        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @csrf
                    <input class="form-control" type="hidden" name="id" id="id" value="{{$promotion->id}}">
            <div class="form-group row">
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <input class="form-control" type="text" name="ptitle" id="ptitle" placeholder="Promotion Title" value="{{$promotion->Title}}">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-12">
                        <label for="pdate">Promotion Date</label>
                        <input class="form-control" type="date" name="pdate" id="pdate" value="{{$promotion->PromotionDate}}">
                    </div>
                </div>
            </div>
                        ...
                        <textarea class="form-control" name="description" id="description" cols="30" rows="10">{{$promotion->Description}}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
