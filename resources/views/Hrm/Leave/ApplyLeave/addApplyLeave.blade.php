                ...
                <div class="col-md-12 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <span>Add New Apply Leave</span>
                        </div>
                        <div class="card-body">
                            <form action="{{route('addApplyLeavePost')}}" class="form-group" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        <label for="applyDate">Date of Application</label>
                                        <input class="form-control" type="date" name="applyDate" id="applyDate">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="leaveDate">Year and Month</label>
                                        <input class="form-control" type="date" name="leaveDate" id="leaveDate">
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group search_select_box">
                                            <select class="form-control" name="leavePurpose" id="leavePurpose" data-live-search="true">
                                                ...
                                                <option value="{{$leavePurpose->id}}">{{$leavePurpose->leavePurpose}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
