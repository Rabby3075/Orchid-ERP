                ...
                <div class="col-md-8 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <span>Update Advance Salary</span>
                        </div>
                        <div class="card-body">
                            <form action="{{route('AdvanceSalaryUpdate')}}" method="POST">
                                @csrf
                                <input class="form-control" type="hidden" name="id" id="id" value="{{$salary->id}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input class="form-control" type="number" name="amount" id="amount" placeholder="Please Enter salary amount" value="{{$salary->Amount}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input class="form-control" type="month" name="salMonth" id="salMonth" min={{$currentMonth}} value="{{$salary->Month}}">
