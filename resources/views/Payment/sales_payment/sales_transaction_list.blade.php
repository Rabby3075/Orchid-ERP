        ...
        <div class="row">
            <div class="col-lg-8 bg-white mx-auto mt-5">
                <div class="card bg-white">
                    <h4 class="card-header text-center">{{$clientName->$clientName}}</h4>

                    <div class="card-body bg-white">
                        <h5 class="mb-4">
                            <div class="d-flex justify-content-between">
                                <a href="{{route('sales.transaction.list',['clientId'=>$clientName->clientId])}}" class="btn btn-primary">Transaction List</a>
                                ...
                                @foreach ($projects as $value)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @include('Payment.sales_Payment.pay_modal')
