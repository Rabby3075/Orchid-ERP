        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-element">
                    <form action="{{route('storeSalesVoucher')}}" method="POST">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label>Bill No.</label>
                                <input  readonly type="text" class="form-control" name="projectInvoice" value="{{$value->projectInvoice}}">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control" id="validationDefault05" name="paid" required>
                            </div>
                            <div class="col-md-3 mb-3">
