                ...
                <div class="modal-element">
                    <form action="{{route('storeVoucher')}}" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label>Bill No.</label>
                                <input  readonly type="text" class="form-control" name="bill" value="{{$value->purchaseId}}">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control" id="validationDefault05" name="amount" required>
                            </div>
                            <div class="col-md-3 mb-3">
