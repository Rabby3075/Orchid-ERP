                    ...
                    <div class="col-md-8 mx-auto">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('update.deposit',['id'=>$deposit->id])}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">date<i class="text-danger">*</i></label>
                                        <div class="col-md-9">
                                            <input type="date" required class="form-control" value="{{$deposit->date}}" name="date"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select required class="form-control" name="bankId">
                                                @foreach($banks as $bank)
                                                    <option {{$bank->id==$deposit->bankId?'selected':''}} value="{{$bank->id}}">{{$bank->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" required class="form-control" value="{{$deposit->amount}}" name="amount"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Charge</label>
                                        <div class="col-md-9">
                                            <input type="number"  value="{{$deposit->charge}}" class="form-control" name="charge"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <img src="" alt="{{$deposit->file}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Note</label>
                                        <div class="col-md-9">
                                            <input type="text"  value="{{$deposit->note}}" class="form-control" name="note"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
